    ...
    <section class="text-gray-700 body-font bg-[#20072e] py-20">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            ...
            <div class="w-3/4 flex justify-center mt-3 ml-auto mr-auto">
                <button class="tracking-wider w-full h-16 px-6 text-white text-base font-semibold py-2 px-3 transition-colors duration-150 bg-[#2ebd59] focus:shadow-outline hover:bg-[#259747] rounded-full">GET STARTED</button>
            </div>
            </div>
